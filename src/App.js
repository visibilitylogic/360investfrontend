...
function App() {
  ...
  //     let response = await fetch(
  //       `https://excelinsure-backend-229kl.ondigitalocean.app/api/trade/user/${user.user._id}`
  //     );
  //     let data = await response.json();
  //     setUser({
  //       user: data,
  ...
  //   (async () => {
  //     let response = await fetch(
  //       `https://excelinsure-backend-229kl.ondigitalocean.app/api/trade/user/${user.user.user._id}`
  //     );
  ...
  let handleSubmitL = (e) => {
    ...
    fetch("https://excelinsure-backend-229kl.ondigitalocean.app/api/login", {
      mode: "cors",
      method: "POST",
      headers: {
  ...
  let handleSubmitR = (e) => {
    ...
    fetch("https://excelinsure-backend-229kl.ondigitalocean.app/api/registration", {
      mode: "cors",
      method: "POST",
      headers: {
        Accept: "application/json",
