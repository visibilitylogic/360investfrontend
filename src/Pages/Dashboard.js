...
class Dashboard extends Component {
  ...
  handleTrading = (e) => {
    ...
    (async () => {
      let response = await fetch(
        `https://excelinsure-backend-229kl.ondigitalocean.app/api/profile/isTrading`,
        {
          mode: "cors",
          method: "PUT",
          headers: {
  ...
  componentDidMount() {
    ...
    (async () => {
      let response = await fetch(
        `https://excelinsure-backend-229kl.ondigitalocean.app/api/autocopytrade/user/${
          this.state.user.user ? this.state.user.user.user._id : ""
        }`
      );
      let data = await response.json();
  ...
  handleSubmitVerification = (e) => {
    ...
    fetch(
      `https://excelinsure-backend-229kl.ondigitalocean.app/api/verify/verificationrequest`,
      {
        mode: "cors",
        method: "POST",
        headers: {
